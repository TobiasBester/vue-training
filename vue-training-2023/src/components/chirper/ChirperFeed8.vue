...
// TODO: 8 - Add a non-reactive, constant variable called MAX_CHIRP_LENGTH with a value of 140 or whatever
// TODO: 8 - Add a non-reactive, constant variable called MAX_LENGTH_ERROR_MSG with a string value
// TODO: 8 - Add watchers for the `newChirpContent` and `reply` values which displays a native alert()
//            if the value surpasses the MAX_CHIRP_LENGTH, the message therein being MAX_LENGTH_ERROR_MSG
// TODO: 8 - Display an error message on the two textareas (using the error-messages prop) if the
//            associated Chirp length is too long
const data = reactive({
